...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Chain the slice() method with the map() and reverse() functions to retrieve the top 10 
    // otu_ids sorted in descending order.
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "Belly button weekly washing frequency",
        showarrow: false
      }]
    };
